...
DBStruct::node Recon_mysql_DBManager::get_node(const std::string k){
  DBStruct::node n;
...
void Recon_dummy_DBManager::insert_node(const DBStruct::node &n){
...
void Recon_dummy_DBManager::update_node(const DBStruct::node &n){
    try{
...
DBStruct::node Recon_dummy_DBManager::get_node(const std::string k){
    DBStruct::node n;
    n.key = k;
    try{
