...
fastGCD::fastGCD(std::vector<NTL::ZZ> INPUT_FN, unsigned int GCD_THREADS, std::string & analyzer_tmp_folder) : 
    INPUT_FN(std::move(INPUT_FN)),
    GCD_THREADS(GCD_THREADS) {
        gcd_folder = analyzer_tmp_folder;
}
